...
public class Elevator extends Thread {
	...
	public static void toSched() {
		...
		if(s.equals("free") ) {
			...
			System.out.println("elv1: " + cMon.getStatus1());
			System.out.println("elv2: " + cMon.getStatus2());
			System.out.println("elv3: " + cMon.getStatus3());
			System.out.println("elv4: " + cMon.getStatus4());
		...
		if(s2.equals("1") ) {
			...
			System.out.println("Elevator2 on the move");
			...
			System.out.println("Elevator3 on the move");
